...
export const HOME_SECTION_VISUALS: HomeSectionVisualMap = {
  hero: {
    id: 'hero',
    sources: {
      avif: `${BASE}/hero-bold-product.avif`,
      webp: `${BASE}/hero-bold-product.webp`,
      fallback: `${BASE}/hero-bold-product.png`
    },
    alt: {
      de: 'Abstrakte 3D-Techniklandschaft mit Lichtbahnen als Symbol für zuverlässige Delivery-Pipelines.',
      en: 'Abstract 3D technology landscape with light trails symbolizing reliable delivery pipelines.'
    },
    caption: {
